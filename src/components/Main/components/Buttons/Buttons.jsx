...
import AddWorker from '../../../ModalWindows/AddWorker/AddWorker';
...
const Buttons = () => {
    ...
    const handleButtonClickWorker = () => {
        setShowModalWorker(true);
    }

    const handleModalCloseWorker = () => {
    ...
    return (
        <div className="Buttons">
            ...
            <div className="button" onClick={handleButtonClickWorker}>
            ...
            {showModalDocument && <AddDocument close={handleModalCloseDocument} />}
            {showModalNote && <AddNote close={handleModalCloseNote} />}
            {showModalWorker && <AddWorker close={handleModalCloseWorker} />}
        </div >
    )
}
